<template>
  <div class="bg-white">
    ...
    <header class="relative bg-white">
        <p class="flex h-7 items-center justify-center bg-slate-950 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
            Envíos, cambios y devoluciones gratis             
        </p>
        <p class="flex h-5 items-center justify-center bg-gray-100 px-4 text-sm sm:px-6 lg:px-8">
              ...
              <div class="flex h-full space-x-8">
                <Popover v-for="category in navigation.categories" :key="category.name" class="flex" v-slot="{ open }">
                  <div class="relative flex">
                    <PopoverButton :class="[open ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-700 hover:text-gray-950', 'relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 text-gray-950 ease-out']">{{ category.name }}</PopoverButton>
                  </div>
                ...
                class="flex items-center text-sm font-medium text-gray-950 hover:text-gray-800">{{ page.name }}</a>
              </div>
            </PopoverGroup>
